...
class SessionHelper:
    ...
    def login(self, user, password):
        ...
        wd.execute_script("arguments[0].value='selenium'",
                          wd.find_element_by_css_selector("div.login input[name=username]"))
    ...
    def close_rodo(self):
        wd = self.app.wd
        wd.find_element_by_css_selector("div[ng-if=isRodoOpen] button").click()
